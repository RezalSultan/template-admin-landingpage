...
export default function FooterHome() {
  return (
    <footer className="relative w-full overflow-hidden bg-[#00091b]">
      <div className="mx-auto flex w-full flex-col items-center justify-center px-5 py-24 xl:container sm:px-10 lg:-mt-10 lg:flex-row lg:gap-16 lg:px-20 xl:mx-auto xl:gap-40">
        <div className="flex flex-col items-center justify-center gap-6 pt-5 lg:items-start">
          <div className="flex flex-col items-center justify-center gap-2 text-white md:flex-row md:justify-start">
            <Link href="/">Logo</Link>
            <h3 className="whitespace-nowrap text-center text-[24px] font-bold text-white sm:text-[28px] xl:text-left">
              Lorem Ipsum
            </h3>
          </div>
          <div className="flex flex-col items-start justify-start gap-2">
            <p className="text-center text-base text-white sm:text-lg lg:text-left">
              Jl. Lorem Ipsum is simply dummy text of the printing and
              typesetting industry
            </p>
            <p className="w-full text-center text-base text-white sm:text-lg lg:text-left">
              Email : loremipsum@example.com
            </p>
          </div>
        </div>
        <div className="flex w-full flex-col justify-center gap-10 pt-10 md:flex-row md:items-start md:justify-between md:gap-12 lg:w-fit lg:flex-col lg:items-end">
          <nav className="w-full lg:pt-14">
            <ul className="flex flex-wrap items-start justify-center gap-1.5 whitespace-nowrap text-center text-base font-bold text-gray-50 sm:gap-3 sm:text-lg md:justify-start lg:flex-nowrap">
              <li>
              ...
              <li>|</li>
              <li>
                <Link href="/gallery-us">Galeri Kami</Link>
              </li>
              <li>|</li>
              <li>
          ...
          <div className="flex w-full flex-col items-center justify-start gap-1 text-base sm:gap-2 sm:whitespace-nowrap sm:text-lg md:items-end lg:-mt-8">
            <div className="flex items-center justify-end gap-1 text-center text-white">
              <div>
                <svg
                  width="24"
                  height="24"
      ...
      <p className="mb-3 text-center text-base text-slate-500">
