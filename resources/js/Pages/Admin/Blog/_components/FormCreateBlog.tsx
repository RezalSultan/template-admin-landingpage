...
import { FormRequestType, SectionRequestType } from "@/types/BlogType";

const FormCreateBlog = ({ errorMessage }: { errorMessage?: string }) => {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    const updatedData = {
      ...data,
      sections: filteredSections.length > 0 ? filteredSections : [],
    };

    console.log(updatedData);

    post(route("blog.create.request"), {
      data: updatedData,
      onError: (errors) => {
    ...
    <>
      <div className="mt-1 w-full">
        <Tabs defaultValue="form" className="w-full">
          <TabsList>
            <TabsTrigger value="form">Form Tambah Artikel</TabsTrigger>
                    ...
                    <Fragment key={index}>
                      ...
                      <div
                        className={`flex w-full flex-col flex-wrap gap-x-4 gap-y-2 transition-all duration-300 ease-in-out md:flex-row ${
                          isCollapsed
                            ? "pointer-events-none -z-50 h-0 opacity-0"
            ...
            <div className="w-full sm:px-5 xl:px-20">
              ...
              {data.cover_image && (
                <div className="mt-4 flex w-full items-center justify-center">
                  <img
                    src={URL.createObjectURL(data.cover_image as File)}
                    ...
                    <>
                      {section.url_asset && (
                        <div className="mt-4 flex w-full flex-col items-center justify-center">
                          <img
                            src={URL.createObjectURL(section.url_asset as File)}
                      ...
                      {section.url_asset && (
                        <div className="mt-4 flex w-full flex-col items-center justify-center">
                          <iframe
                            ...
                            allowFullScreen
                            className="w-9/12 rounded-sm md:h-[calc(100vh/2.3)] xl:h-[calc(100vh/1.5)]"
                            title="YouTube Video"
                          ></iframe>
                          <div className="mt-1 text-center text-sm italic text-foreground/75">
                            {section.caption}
